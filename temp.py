...
graph = sns.countplot(data=df, x='previous_month_end_balance', y='current_balance', hue='churn')
plt.show()
...
#relation with previous_month_debit & churn
g=sns.FacetGrid(df,col='churn')
g.map(plt.hist,'previous_month_debit',bins=20)
plt.show()
